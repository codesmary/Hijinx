...
public abstract class GameLoop extends Canvas implements Runnable, IO {
	...
	public void run() {
		...
		double secondsPerFrame = 1 / GameLoop.fps;
		...
		while (this.running) {
			...
			/*
			 * int secondInMillisec = 1000; if(System.currentTimeMillis() - timerMillisec >
			 * secondInMillisec){ timerMillisec += secondInMillisec;
			 * System.out.println("Fps: " + framesSec + " Ticks: " + ticksSec); framesSec =
			 * ticksSec = 0; }
			 */
		}
	}
